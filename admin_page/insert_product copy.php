            ...
            ?>
                    ...
                    <div class="form-group"><!-- form-group Begin -->
                        ...
                        <div class="col-md-1" ><!-- col-md-6 Begin -->
                            ...
                            <input name="small" type="number" min="0" class="form-control" required placeholder="S">
                            
                        </div><!-- col-md-6 Finish -->
                        <div class="col-md-1"><!-- col-md-6 Begin -->
                            
                            <input name="medium" type="number" min="0" class="form-control" required placeholder="M">
                            
                        </div><!-- col-md-6 Finish -->
                        <div class="col-md-1"><!-- col-md-6 Begin -->
                            
                            <input name="large" type="number" min="0" class="form-control" required placeholder="L">
                            
                        </div><!-- col-md-6 Finish -->
                        <div class="col-md-1"><!-- col-md-6 Begin -->
                            
                            <input name="x_large" type="number" min="0" class="form-control" required placeholder="XL">
                            
                        </div><!-- col-md-6 Finish -->
                        <div class="col-md-2"><!-- col-md-6 Begin -->
                            
                            <input name="xx_large" type="number" min="0" class="form-control" required placeholder="XXL">
...
if(isset($_POST['submit'])){
    ...
    $medium = $_POST['medium'];
    $large = $_POST['large'];
    $xlarge = $_POST['x_large'];
    $xxlarge = $_POST['xx_large'];
