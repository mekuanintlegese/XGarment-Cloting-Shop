        ...
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    ...
                    <i class="fa fa-dashboard"></i> Dashboard / View Today's Order
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">
                        ...
                        <i class="fa fa-tags"></i> New Orders Today
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                $get_orders = "select * from customer_orders where order_date='$date' and payment is not null and payment != ''";
                                ...
                                if ($number_of_results > 0) {
                                    ...
                                    $sql_products = "SELECT * FROM customer_orders where order_date='$date' and payment is not null and payment != '' ORDER BY order_id DESC ";
                                    ...
                                    while ($row_order = mysqli_fetch_array($result)) {
                                        ...
                                        <td>  $phone </td>
                                        <td> <a href='index.php?view_order=$invoice_no'>  $invoice_no </a></td>
