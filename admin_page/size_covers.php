...
<?php 
    ...
    if(isset($_GET['size_covers'])){
        ...
        $edit_id = $_GET['size_covers'];
        
        $size_covers1 = "select * from covers where id=15";        
        $run_size_covers1 = mysqli_query($con,$size_covers1);        
        $row_size_covers1 = mysqli_fetch_array($run_size_covers1);        
        $id1 = $row_size_covers1['id'];
        $l11 = $row_size_covers1['l1'];
        $l21 = $row_size_covers1['l2'];       
        $c_image1 = $row_size_covers1['c_image'];

        $size_covers2 = "select * from covers where id=16";        
        $run_size_covers2 = mysqli_query($con,$size_covers2);        
        $row_size_covers2 = mysqli_fetch_array($run_size_covers2);        
        $id2 = $row_size_covers2['id'];
        $l12 = $row_size_covers2['l1'];
        $l22 = $row_size_covers2['l2'];       
        $c_image2 = $row_size_covers2['c_image'];
        
        $size_covers3 = "select * from covers where id=17";        
        $run_size_covers3 = mysqli_query($con,$size_covers3);        
        $row_size_covers3 = mysqli_fetch_array($run_size_covers3);        
        $id3 = $row_size_covers3['id'];
        $l13 = $row_size_covers3['l1'];
        $l23 = $row_size_covers3['l2'];       
        $c_image3 = $row_size_covers3['c_image'];

                
        $size_covers4 = "select * from covers where id=18";        
        $run_size_covers4 = mysqli_query($con,$size_covers4);        
        $row_size_covers4 = mysqli_fetch_array($run_size_covers4);        
        $id4 = $row_size_covers4['id'];
        $l14 = $row_size_covers4['l1'];
        $l24 = $row_size_covers4['l2'];       
        $c_image4 = $row_size_covers4['c_image'];

                        
        $size_covers5 = "select * from covers where id=19";        
        $run_size_covers5 = mysqli_query($con,$size_covers5);        
        $row_size_covers5 = mysqli_fetch_array($run_size_covers5);        
        $id5 = $row_size_covers5['id'];
        $l15 = $row_size_covers5['l1'];
        $l25 = $row_size_covers5['l2'];       
        $c_image5 = $row_size_covers5['c_image'];

                        
        $size_covers6 = "select * from covers where id=20";        
        $run_size_covers6 = mysqli_query($con,$size_covers6);        
        $row_size_covers6 = mysqli_fetch_array($run_size_covers6);        
        $id6 = $row_size_covers6['id'];
        $l16 = $row_size_covers6['l1'];
        $l26 = $row_size_covers6['l2'];       
        $c_image6 = $row_size_covers6['c_image'];

                        
        $size_covers7 = "select * from covers where id=21";        
        $run_size_covers7 = mysqli_query($con,$size_covers7);        
        $row_size_covers7 = mysqli_fetch_array($run_size_covers7);        
        $id7 = $row_size_covers7['id'];
        $l17 = $row_size_covers7['l1'];
        $l27 = $row_size_covers7['l2'];       
        $c_image7 = $row_size_covers7['c_image'];

                        
        $size_covers8 = "select * from covers where id=22";        
        $run_size_covers8 = mysqli_query($con,$size_covers8);        
        $row_size_covers8 = mysqli_fetch_array($run_size_covers8);        
        $id8 = $row_size_covers8['id'];
        $l18 = $row_size_covers8['l1'];
        $l28 = $row_size_covers8['l2'];       
        $c_image8 = $row_size_covers8['c_image'];

                        
        $size_covers9 = "select * from covers where id=23";        
        $run_size_covers9 = mysqli_query($con,$size_covers9);        
        $row_size_covers9 = mysqli_fetch_array($run_size_covers9);        
        $id9 = $row_size_covers9['id'];
        $l19 = $row_size_covers9['l1'];
        $l29 = $row_size_covers9['l2'];       
        $c_image9 = $row_size_covers9['c_image'];

                        
        $size_covers10 = "select * from covers where id=24";        
        $run_size_covers10 = mysqli_query($con,$size_covers10);        
        $row_size_covers10 = mysqli_fetch_array($run_size_covers10);        
        $id10 = $row_size_covers10['id'];
        $l110 = $row_size_covers10['l1'];
        $l210 = $row_size_covers10['l2'];       
        $c_image10 = $row_size_covers10['c_image'];
    ...
    <div class="col-lg-12"><!-- col-lg-12 begin -->
        <ol class="breadcrumb"><!-- breadcrumb begin -->
            <li>
                ...
                <i class="fa fa-dashboard"></i> Dashboard / Edit Plus Size Cover
        ...
        <div class="panel panel-default"><!-- panel panel-default begin -->
            <div class="panel-heading"><!-- panel-heading begin -->
                <h3 class="panel-title"><!-- panel-title begin -->
                    ...
                    <i class="fa fa-image fa-fw"></i> Edit Plus Size Covers
            ...
            <div class="panel-body"><!-- panel-body begin -->
                                        <form action="" class="form-horizontal" method="post" enctype="multipart/form-data"><!-- form-horizontal begin -->
                                            <div class="form-group"><!-- form-group begin -->
                                                ...
                                                <label for="" class="control-label col-md-3" style="color: green;"> KNITWEARS Intro</label> 
...
<?php  
    ...
    if(isset($_POST['updatetop'])){
        ...
        if ($_FILES['woman_top']['size'] == 0)        {
            ...
            $update_slide = "update covers set l1='$l1t',l2='$l2t' where id=15";            
            $run_update_slide = mysqli_query($con,$update_slide);            
            if($run_update_slide){                
                echo "<script>alert('Plus Size Top Intro has been Updated Successfully')</script>";             
                echo "<script>window.open('index.php?size_covers','_self')</script>";                
            }
            ...
            $update_slide = "update covers set l1='$l1t',l2='$l2t',c_image='$newname1' where id=15";            
            $run_update_slide = mysqli_query($con,$update_slide);
            
            if($run_update_slide){                
                echo "<script>alert('Plus Size TOP Cover Image has been Updated Successfully')</script>";            
                echo "<script>window.open('index.php?size_covers','_self')</script>";                
            }
        }
    ...
    if(isset($_POST['updatedress'])){
        ...
        if ($_FILES['woman_dress']['size'] == 0) {
            ...
            $update_slide = "update covers set l1='$l1d',l2='$l2d' where id=16";            
            $run_update_slide = mysqli_query($con,$update_slide);            
            if($run_update_slide){                
                echo "<script>alert('Plus Size Dress Intro has been Updated Successfully')</script>";             
                echo "<script>window.open('index.php?size_covers','_self')</script>";                
            }
            ...
            $update_slide = "update covers set l1='$l1d',l2='$l2d',c_image='$newname2' where id=16";            
            $run_update_slide = mysqli_query($con,$update_slide);
            
            if($run_update_slide){                
                echo "<script>alert('Plus Size DRESS Cover Image has been Updated Successfully')</script>";            
                echo "<script>window.open('index.php?size_covers','_self')</script>";                
            }
        }
    ...
    if(isset($_POST['updatebottom'])){
        ...
        if ($_FILES['woman_bottom']['size'] == 0) {
            ...
            $update_slide = "update covers set l1='$l1b',l2='$l2b' where id=17";            
            $run_update_slide = mysqli_query($con,$update_slide);            
            if($run_update_slide){                
                echo "<script>alert('Plus Size Dress Intro has been Updated Successfully')</script>";             
                echo "<script>window.open('index.php?size_covers','_self')</script>";                
            ...
            $update_slide = "update covers set l1='$l1b',l2='$l2b',c_image='$newname3' where id=17";            
            $run_update_slide = mysqli_query($con,$update_slide);
    ...
    if(isset($_POST['womanblouse'])){
        ...
        if ($_FILES['woman_blouse']['size'] == 0) {
            ...
            $update_slide = "update covers set l1='$l1bl',l2='$l2bl' where id=18";            
            $run_update_slide = mysqli_query($con,$update_slide);            
            if($run_update_slide){                
                echo "<script>alert('Plus Size Blouse Intro has been Updated Successfully')</script>";             
                echo "<script>window.open('index.php?size_covers','_self')</script>";                
            }
            ...
            $update_slide = "update covers set l1='$l1bl',l2='$l2bl',c_image='$newname4' where id=18";            
            $run_update_slide = mysqli_query($con,$update_slide);
            
            if($run_update_slide){                
                echo "<script>alert('Plus Size Blouse Cover Image has been Updated Successfully')</script>";            
                echo "<script>window.open('index.php?size_covers','_self')</script>";                
            }
        }
    ...
    if(isset($_POST['updatedenim'])){
        ...
        if ($_FILES['woman_denim']['size'] == 0) {
            ...
            $update_slide = "update covers set l1='$l1dn',l2='$l2dn' where id=19";            
            $run_update_slide = mysqli_query($con,$update_slide);            
            if($run_update_slide){                
                echo "<script>alert('Plus Size Denim Intro has been Updated Successfully')</script>";             
                echo "<script>window.open('index.php?size_covers','_self')</script>";                
            }
            ...
            $update_slide = "update covers set l1='$l1dn',l2='$l2dn',c_image='$newname5' where id=19";            
            $run_update_slide = mysqli_query($con,$update_slide);
            
            if($run_update_slide){                
                echo "<script>alert('Plus Size Denim Cover Image has been Updated Successfully')</script>";            
                echo "<script>window.open('index.php?size_covers','_self')</script>";                
            }
        }
    ...
    if(isset($_POST['updatejumpsuits'])){
        ...
        if ($_FILES['woman_jumpsuits']['size'] == 0) {
            ...
            $update_slide = "update covers set l1='$l1js',l2='$l2js' where id=20";            
            $run_update_slide = mysqli_query($con,$update_slide);            
            if($run_update_slide){                
                echo "<script>alert('Plus Size Jumpsuits Intro has been Updated Successfully')</script>";             
                echo "<script>window.open('index.php?size_covers','_self')</script>";                
            }
            ...
            $update_slide = "update covers set l1='$l1js',l2='$l2js',c_image='$newname6' where id=20";            
            $run_update_slide = mysqli_query($con,$update_slide);
            
            if($run_update_slide){                
                echo "<script>alert('Plus Size Jumpsuits Cover Image has been Updated Successfully')</script>";            
                echo "<script>window.open('index.php?size_covers','_self')</script>";                
            }
        }
    ...
    if(isset($_POST['updateshirts'])){
        ...
        if ($_FILES['woman_tshirts']['size'] == 0) {
            ...
            $update_slide = "update covers set l1='$l1ts',l2='$l2ts' where id=21";            
            $run_update_slide = mysqli_query($con,$update_slide);            
            if($run_update_slide){                
                echo "<script>alert('Plus Size T-SHIRTS Intro has been Updated Successfully')</script>";             
                echo "<script>window.open('index.php?size_covers','_self')</script>";                
            }
            ...
            $update_slide = "update covers set l1='$l1ts',l2='$l2ts',c_image='$newname7' where id=21";            
            $run_update_slide = mysqli_query($con,$update_slide);
            
            if($run_update_slide){                
                echo "<script>alert('Plus Size T-SHIRTS Cover Image has been Updated Successfully')</script>";            
                echo "<script>window.open('index.php?size_covers','_self')</script>";                
            }
        }
    ...
    if(isset($_POST['updatetanktops'])){
        ...
        if ($_FILES['woman_tanktops']['size'] == 0) {
            ...
            $update_slide = "update covers set l1='$l1tt',l2='$l2tt' where id=22";            
            $run_update_slide = mysqli_query($con,$update_slide);            
            if($run_update_slide){                
                echo "<script>alert('Plus Size TANKTOPS Intro has been Updated Successfully')</script>";             
                echo "<script>window.open('index.php?size_covers','_self')</script>";                
            }
            ...
            $update_slide = "update covers set l1='$l1tt',l2='$l2tt',c_image='$newname8' where id=22";            
            $run_update_slide = mysqli_query($con,$update_slide);
            
            if($run_update_slide){                
                echo "<script>alert('Plus Size TANKTOPS Cover Image has been Updated Successfully')</script>";            
                echo "<script>window.open('index.php?size_covers','_self')</script>";                
            }
        }
    ...
    if(isset($_POST['updatedkintwear'])){
        ...
        if ($_FILES['woman_kintwears']['size'] == 0) {
            ...
            $update_slide = "update covers set l1='$l1kw',l2='$l2kw' where id=23";            
            $run_update_slide = mysqli_query($con,$update_slide);            
            if($run_update_slide){                
                echo "<script>alert('Plus Size KintWear Intro has been Updated Successfully')</script>";             
                echo "<script>window.open('index.php?size_covers','_self')</script>";                
            }
            ...
            $update_slide = "update covers set l1='$l1kw',l2='$l2kw',c_image='$newname9' where id=23";            
            $run_update_slide = mysqli_query($con,$update_slide);
            
            if($run_update_slide){                
                echo "<script>alert('Plus Size KintWear Cover Image has been Updated Successfully')</script>";            
                echo "<script>window.open('index.php?size_covers','_self')</script>";                
            }
        }
    ...
    if(isset($_POST['updatedsweetshirt'])){
        ...
        if ($_FILES['woman_sweatshirt']['size'] == 0) {
            ...
            $update_slide = "update covers set l1='$l1sws',l2='$l2sws' where id=24";            
            $run_update_slide = mysqli_query($con,$update_slide);            
            if($run_update_slide){                
                echo "<script>alert('Plus New Arrivals Intro has been Updated Successfully')</script>";             
                echo "<script>window.open('index.php?size_covers','_self')</script>";                
            }
            ...
            $rename10 = 'WomanNEWCover'.date('YmdHis01');  
            ...
            $update_slide = "update covers set l1='$l1sws',l2='$l2sws',c_image='$newname10' where id=24";            
            $run_update_slide = mysqli_query($con,$update_slide);
            
            if($run_update_slide){                
                echo "<script>alert('Plus New Arrivals Cover Image has been Updated Successfully')</script>";            
                echo "<script>window.open('index.php?size_covers','_self')</script>";                
            }
        }
