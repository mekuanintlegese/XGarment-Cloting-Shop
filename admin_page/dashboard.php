        ...
        <div class="panel panel-orange"><!-- panel panel-yellow begin -->
            ...
            <div class="panel-heading"><!-- panel-heading begin -->
                <div class="row"><!-- panel-heading row begin -->
                    ...
                    <div class="col-xs-9 text-right"><!-- col-xs-9 text-right begin -->
                        <div class="huge"> <?php echo $count_today_orders; ?> </div>
            ...
            <a href="index.php?today_orders"><!-- a href begin -->
                <div class="panel-footer"><!-- panel-footer begin -->
                    ...
                    <table class="table table-hover table-striped table-bordered"><!-- table table-hover table-striped table-bordered begin -->
                        ...
                        <tbody><!-- tbody begin -->
                            ...
                            <?php 
                                ...
                                $get_order = "select * from customer_orders where payment is not null and payment != '' order by order_id DESC LIMIT 0,5";
                            ...
                            <tr><!-- tr begin -->
                                ...
                                <td> <a href="index.php?view_order=<?php echo $invoice_no; ?>">  <?php echo $invoice_no; ?> </a>  </td>
                                <td><a href="https://Xclusiveexclusive.com/detail.php?product=<?php echo $product_id; ?>">  <?php echo $product_title; ?> </a> </td>
                                <td> <?php echo $qty; ?> </td>
                                <td> <?php echo $size; ?> </td>
                                <td>
        ...
        <div class="panel"><!-- panel begin -->
            <div class="panel-body"><!-- panel-body begin -->
                <div class="mb-md thumb-info"><!-- mb-md thumb-info begin -->
                    ...
                    <img width="250px;" src="admin_images/<?php echo $admin_image; ?>" alt="<?php echo $admin_image; ?>" class="rounded img-responsive">
